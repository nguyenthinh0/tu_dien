...
CREATE TABLE `gopy` (
  ...
  `DoiTuongGY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `phuongthang` (
  ...
  `MaBaoChe` int NOT NULL,
  `TacDung` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
