...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(BASE_URL . 'frontend/assets/css/style.css'); ?>">
...
<body>
    <header>
        <img src="<?php echo e(BASE_URL .'frontend/assets/images/panner.png'); ?>" class="img-fluid" alt="" srcset="">
    ...
    <?php if($_SERVER['REQUEST_URI'] != "" && $_SERVER['REQUEST_URI'] != "/" && $_SERVER['REQUEST_URI'] != "/tim-kiem-nc" && $_SERVER['REQUEST_URI'] != "/rate"): ?>
                ...
                <div class="modal-body">
                    <form action="/search" method="post">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="LoaiTN" value="<?php echo e(explode('/', $_SERVER['REQUEST_URI'])[1]); ?>">
                        </div>
    ...
    <script src="<?php echo e(BASE_URL . 'frontend/assets/js/script.js'); ?>"></script>
    ...
    <script src="<?php echo e(BASE_URL . 'backend/assets/js/jquery-3.6.0.slim.min.js'); ?>"> </script>
    <script src="<?php echo e(BASE_URL . 'backend/assets/js/jquery-3.6.0.min.js'); ?>"> </script>
    <script src="<?php echo e(BASE_URL . 'backend/assets/js/gopy.js'); ?>"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\doan_2021\resources\views/layouts/index.blade.php ENDPATH**/ ?>